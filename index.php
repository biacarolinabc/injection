...
if(isset($_POST['RM']) || isset($_POST['Senha'])){
    //criar uma tabela com dois campos no SQL
...
<body class="bg-danger">
    ...
    <form action="" method="POST" class="border p-4 rounded" style="background-color: #fa7070;">
        <input type="text" class="form-control" placeholder="RM do Aluno" name="RM">
        <br>
        <input type="password" class="form-control" placeholder="Senha" name="Senha">
        <br>
        <button type="submit" class="btn btn-dark btn-sm w-100">Logar</button>
    </form>
